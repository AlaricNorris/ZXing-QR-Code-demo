...
public final class PreferencesFragment extends PreferenceFragment
    ...
    public void onCreate ( Bundle icicle ) {
        ...
        mSwitchPreference = ( SwitchPreference ) findPreference( "preferences_use_front_camera" );
        checkBoxPrefs = findDecodePrefs(
                preferences, PreferencesActivity.KEY_DECODE_1D_PRODUCT,
                PreferencesActivity.KEY_DECODE_1D_INDUSTRIAL, PreferencesActivity.KEY_DECODE_QR,
                PreferencesActivity.KEY_DECODE_DATA_MATRIX, PreferencesActivity.KEY_DECODE_AZTEC,
                PreferencesActivity.KEY_DECODE_PDF417
        );
        disableLastCheckedPref();

        EditTextPreference customProductSearch = ( EditTextPreference ) preferences.findPreference(
